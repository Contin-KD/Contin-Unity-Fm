    ...
    public partial struct SkillCDConfig
    {
        public static void DeserializeByAddressable(string directory)
        {
            ...
            for (int i = 0; i < array.Count; i++)
            {
                ...
                SkillCDConfig data = (SkillCDConfig)dataObject.ToObject(typeof(SkillCDConfig));
                datas.Add(data);
        ...
        {
            string bundleName = $"{subFolder}/SkillCDConfig.bytes".ToLower();
        ...
        private static List<SkillCDConfig> datas;
        private static Dictionary<int, int> indexMap;
        public static SkillCDConfig ByID(int id)
        {
            if (id <= 0)
            {
                return Null;
            ...
            {
                throw new System.Exception($"SkillCDConfig找不到ID:{id}");
            }
            return ByIndex(index);
        }
        public static SkillCDConfig ByIndex(int index)
        {
            return datas[index];
        }
        public bool IsNull { get; private set; }
        public static SkillCDConfig Null { get; } = new SkillCDConfig() { IsNull = true }; 
        public System.Int32 ID { get; set; }
        public string Description { get; set; }
        public System.Single CD { get; set; }
        public System.Boolean CanCharge { get; set; }
        public System.Int32 MaxChargeCount { get; set; }
    }
}
