    ...
    public partial struct SkillConfig
    {
        public static void DeserializeByAddressable(string directory)
        {
            ...
            for (int i = 0; i < array.Count; i++)
            {
                ...
                SkillConfig data = (SkillConfig)dataObject.ToObject(typeof(SkillConfig));
                datas.Add(data);
        ...
        {
            string bundleName = $"{subFolder}/SkillConfig.bytes".ToLower();
        ...
        private static List<SkillConfig> datas;
        private static Dictionary<int, int> indexMap;
        public static SkillConfig ByID(int id)
        {
            if (id <= 0)
            {
                return Null;
            ...
            {
                throw new System.Exception($"SkillConfig找不到ID:{id}");
            }
            return ByIndex(index);
        }
        public static SkillConfig ByIndex(int index)
        {
            return datas[index];
        }
        public bool IsNull { get; private set; }
        public static SkillConfig Null { get; } = new SkillConfig() { IsNull = true }; 
        public System.Int32 ID { get; set; }
        public string Description { get; set; }
        public string Name { get; set; }
        public System.Int32 Icon { get; set; }
        public SkillGroupType GroupType { get; set; }
        public System.Int32[] GroupSkills { get; set; }
        public System.Boolean MoveCast { get; set; }
        public System.Single MoveSpeed { get; set; }
        public string Animation { get; set; }
        public string FX { get; set; }
        public string SFX { get; set; }
        public System.Single[] SkillCombo { get; set; }
        public System.Single Duration { get; set; }
        public System.Int32 CDGroup { get; set; }
        public SkillTargetType InputTarget { get; set; }
        public CharacterRelationType InputTargetRelation { get; set; }
        public System.Int32[] SelfBuffs { get; set; }
