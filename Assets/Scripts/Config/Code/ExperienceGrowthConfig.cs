    ...
    public partial struct ExperienceGrowthConfig
    {
        public static void DeserializeByAddressable(string directory)
        {
            ...
            for (int i = 0; i < array.Count; i++)
            {
                ...
                ExperienceGrowthConfig data = (ExperienceGrowthConfig)dataObject.ToObject(typeof(ExperienceGrowthConfig));
                datas.Add(data);
        ...
        {
            string bundleName = $"{subFolder}/ExperienceGrowthConfig.bytes".ToLower();
        ...
        private static List<ExperienceGrowthConfig> datas;
        private static Dictionary<int, int> indexMap;
        public static ExperienceGrowthConfig ByID(int id)
        {
            if (id <= 0)
            {
                return Null;
            ...
            {
                throw new System.Exception($"ExperienceGrowthConfig找不到ID:{id}");
            }
            return ByIndex(index);
        }
        public static ExperienceGrowthConfig ByIndex(int index)
        {
            return datas[index];
        }
        public bool IsNull { get; private set; }
        public static ExperienceGrowthConfig Null { get; } = new ExperienceGrowthConfig() { IsNull = true }; 
        public System.Int32 ID { get; set; }
        public string Description { get; set; }
        public System.Int32 CharacterLv { get; set; }
