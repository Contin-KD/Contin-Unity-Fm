    ...
    public partial struct RandomAttributeGroupConfig
    {
        public static void DeserializeByAddressable(string directory)
        {
            ...
            for (int i = 0; i < array.Count; i++)
            {
                ...
                RandomAttributeGroupConfig data = (RandomAttributeGroupConfig)dataObject.ToObject(typeof(RandomAttributeGroupConfig));
                datas.Add(data);
        ...
        {
            string bundleName = $"{subFolder}/RandomAttributeGroupConfig.bytes".ToLower();
        ...
        private static List<RandomAttributeGroupConfig> datas;
        private static Dictionary<int, int> indexMap;
        public static RandomAttributeGroupConfig ByID(int id)
        {
            if (id <= 0)
            {
                return Null;
            ...
            {
                throw new System.Exception($"RandomAttributeGroupConfig找不到ID:{id}");
            }
            return ByIndex(index);
        }
        public static RandomAttributeGroupConfig ByIndex(int index)
        {
            return datas[index];
        }
        public bool IsNull { get; private set; }
        public static RandomAttributeGroupConfig Null { get; } = new RandomAttributeGroupConfig() { IsNull = true }; 
        public System.Int32 ID { get; set; }
        public string Description { get; set; }
        public System.Int32 RandomAttributeGroupId { get; set; }
        public System.Int32[] RandomAttributeRewardId { get; set; }
        public System.Int32[] RandomAttributeRewardWeight { get; set; }
    }
}
