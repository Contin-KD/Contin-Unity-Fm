    ...
    public partial struct DropRewardGroupConfig
    {
        public static void DeserializeByAddressable(string directory)
        {
            ...
            for (int i = 0; i < array.Count; i++)
            {
                ...
                DropRewardGroupConfig data = (DropRewardGroupConfig)dataObject.ToObject(typeof(DropRewardGroupConfig));
                datas.Add(data);
        ...
        {
            string bundleName = $"{subFolder}/DropRewardGroupConfig.bytes".ToLower();
        ...
        private static List<DropRewardGroupConfig> datas;
        private static Dictionary<int, int> indexMap;
        public static DropRewardGroupConfig ByID(int id)
        {
            if (id <= 0)
            {
                return Null;
            ...
            {
                throw new System.Exception($"DropRewardGroupConfig找不到ID:{id}");
            }
            return ByIndex(index);
        }
        public static DropRewardGroupConfig ByIndex(int index)
        {
            return datas[index];
        }
        public bool IsNull { get; private set; }
        public static DropRewardGroupConfig Null { get; } = new DropRewardGroupConfig() { IsNull = true }; 
        ...
        public System.Int32 MinNum { get; set; }
        public System.Int32 MaxNum { get; set; }
